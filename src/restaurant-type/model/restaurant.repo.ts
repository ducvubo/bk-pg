...
export class RestaurantTypeRepository {
  ...
  async create({ restaurant_type_name }: { restaurant_type_name: string }) {
    return await this.restaurantTypeModel.create({ restaurant_type_name })
  }

  async getRestaurantTypelByName({ restaurant_type_name }: { restaurant_type_name: string }) {
    return this.restaurantTypeModel.findOne({ restaurant_type_name }).exec()
  }

  async getRestaurantTypeByNameInfor({ restaurant_type_name }: { restaurant_type_name: string }) {
